...
export default function CadastroPadrinho(){
    ...
    async function cadastrarPadrinho(){
    ...
    await firestore()
        ...
        .then(() => {
            ...
            .set(enviEn)
            .then(() => {
                    console.log('Padrinho Cadastrado');
                });
            });
    }

    function logon(){
        if( email === '' || password === '' || nome === '' || razaoSocial === '' || cnpj === '' || responsavel === '' || cpf === '' || phone === '' || uf === '' || cidade === '' || cep === '' || rua === '' || numero === '' || complemento === '' ){
    ...
    return(
        <ScrollView style={{flex:1, backgroundColor:'#F7FCFB'}}>
            ...
            <Text style={{fontSize:20, fontWeight:'bold'}}>(Pessoa Jurídica)</Text>
            <Image 
            ...
            <Text style={{fontSize:16, marginTop:20}}>RAZÃO SOCIAL*</Text>
                ...
                />
                <Text style={{marginTop:15, fontSize:16}}>CNPJ*</Text>
                <TextInput 
                    value={cnpj}
                    ...
                    placeholderTextColor={'grey'}
                />
                <Text style={{marginTop:15, fontSize:16}}>RESPONSÁVEL*</Text>
                <TextInput 
                    value={responsavel}
            ...
            <View style={{width:'100%', paddingLeft:30, marginTop:20, justifyContent:'center', paddingBottom:20}}>
            <Text style={{fontSize:20, fontWeight:'bold'}}>INFORMAÇÕES DE CADASTRO</Text>
            <Text style={{fontSize:20, fontWeight:'bold'}}>(Pessoa Física)</Text>
